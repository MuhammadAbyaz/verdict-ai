...
const course_entity_1 = require("../modules/course/entities/course.entity");
...
const option_entity_1 = require("../modules/option/entities/option.entity");
const test_entity_1 = require("../modules/test/entities/test.entity");
const seed = async () => {
    const dataSource = new typeorm_1.DataSource(config_1.dataSourceOptions);
    await dataSource.initialize();
    const courseRepo = dataSource.getRepository(course_entity_1.Course);
    const moduleRepo = dataSource.getRepository(module_entity_1.Module);
    ...
    const optionRepo = dataSource.getRepository(option_entity_1.Option);
    ...
    const course1 = courseRepo.create({
        ...
        description: 'Provides foundational knowledge of the legal system, its history, and core concepts, aligning with the initial semesters of LLB programs.',
        level: course_levels_1.COURSE_LEVEL.BEGINNER,
        test: test1,
    });
    await courseRepo.save(course1);
    const course2 = courseRepo.create({
        title: 'Constitutional Law of Pakistan',
        description: 'Delves into the constitutional framework of Pakistan, exploring its development, principles, and institutions.',
        level: course_levels_1.COURSE_LEVEL.INTERMEDIATE,
        test: test2,
    });
    await courseRepo.save(course2);
    const course3 = courseRepo.create({
        title: 'Criminal Law and Procedure',
        description: 'Focuses on the principles of criminal law, offenses, and the procedural aspects of criminal justice in Pakistan.',
        level: course_levels_1.COURSE_LEVEL.ADVANCE,
        test: test3,
    });
    ...
    const lessons1_1 = [
        {
            title: 'What is Law?',
            content: 'Law is a system of rules created and enforced through social or governmental institutions to regulate behavior. This lesson explores the definition and nature of law.',
            order: 1,
        },
        {
            title: 'Importance of Law in Society',
            content: 'This lesson examines why laws are essential for maintaining order, resolving disputes, and protecting rights in a functioning society.',
            order: 2,
        },
        {
            title: 'Historical Evolution of Legal Systems',
            content: 'An overview of how legal systems have evolved from ancient codes to modern legal frameworks, including major historical milestones.',
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module1_1.id } }));
    ...
    const module1_2 = moduleRepo.create({
        ...
        description: 'Understanding the various origins of legal principles and rules.',
        order: 2,
        xp: 100,
        course: { id: course1.id },
    });
    ...
    const lessons1_2 = [
        {
            ...
            content: 'This lesson covers the primary sources of law, focusing on written constitutions and legislation enacted by governmental bodies.',
            order: 1,
        },
        {
            title: 'Judicial Precedents',
            content: 'An exploration of case law and the doctrine of precedent (stare decisis) and how court decisions become binding law.',
            order: 2,
        },
        {
            title: 'Customary and Religious Laws',
            content: 'This lesson examines how customs, traditions, and religious principles serve as sources of law in various legal systems.',
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module1_2.id } }));
    ...
    const lessons1_3 = [
        {
            ...
            content: 'This lesson explores the hierarchical organization of courts and their jurisdiction in the legal system.',
            order: 1,
        },
        {
            title: 'Role of Judges and Lawyers',
            content: 'An examination of the responsibilities and functions of key legal professionals in the administration of justice.',
            order: 2,
        },
        {
            title: 'Legal Aid and Public Interest Litigation',
            content: 'This lesson covers how legal services are made accessible to disadvantaged groups and how public interest cases are pursued.',
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module1_3.id } }));
    ...
    const lessons1_4 = [
        {
            ...
            content: 'This lesson examines the principles and methods used to interpret and apply legislative texts.',
            order: 1,
        },
        {
            title: 'Case Law Analysis',
            content: 'An exploration of how to read, analyze, and apply judicial decisions in legal reasoning.',
            order: 2,
        },
        {
            title: 'Logical Reasoning in Law',
            content: 'This lesson covers the application of logical principles and reasoning methods in legal argumentation.',
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module1_4.id } }));
    ...
    const lessons1_5 = [
        {
            ...
            content: 'This lesson examines the landmark international document establishing the fundamental human rights to be universally protected.',
            order: 1,
        },
        {
            title: 'Rights in the Pakistani Constitution',
            content: 'An overview of the fundamental rights enshrined in the Constitution of Pakistan and their scope.',
            order: 2,
        },
        {
            title: 'Enforcement Mechanisms',
            content: 'This lesson explores how human rights are enforced through domestic and international legal frameworks.',
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module1_5.id } }));
    ...
    const lessons2_1 = [
        {
            ...
            content: 'This lesson examines the constitutional developments in the Indian subcontinent prior to 1947.',
            order: 1,
        },
        {
            title: '1956, 1962, and 1973 Constitutions',
            content: "An overview of Pakistan's three constitutions, their key features, and the political contexts in which they were adopted.",
            order: 2,
        },
        {
            title: 'Amendments and Their Impacts',
            content: "This lesson analyzes significant constitutional amendments and their effects on Pakistan's legal and political system.",
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module2_1.id } }));
    ...
    const lessons2_2 = [
        {
            ...
            content: 'This lesson examines the fundamental rights enshrined in the Constitution of Pakistan.',
            order: 1,
        },
        {
            title: 'Limitations and Enforcement',
            content: 'An overview of constitutional restrictions on rights and mechanisms for their enforcement.',
            order: 2,
        },
        {
            title: 'Role of Judiciary in Rights Protection',
            content: 'This lesson explores how Pakistani courts have interpreted and protected fundamental rights.',
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module2_2.id } }));
    ...
    const lessons2_3 = [
        {
            ...
            content: "This lesson examines the federal design established by Pakistan's Constitution.",
            order: 1,
        },
        {
            title: 'Roles of Federal and Provincial Governments',
            content: 'An overview of respective powers and functions of national and provincial governments.',
            order: 2,
        },
        {
            title: 'Council of Common Interests',
            content: 'This lesson explores the constitutional body designed to harmonize federal-provincial relations.',
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module2_3.id } }));
    ...
    const lessons2_4 = [
        {
            ...
            content: 'This lesson examines the constitutional roles of the executive, legislature, and judiciary.',
            order: 1,
        },
        {
            title: 'Checks and Balances',
            content: 'An overview of mechanisms through which each branch restrains the others.',
            order: 2,
        },
        {
            title: 'Separation of Powers',
            content: 'This lesson explores the constitutional principle of dividing governmental authority.',
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module2_4.id } }));
    ...
    const lessons2_5 = [
        {
            ...
            content: 'This lesson examines constitutional provisions for dealing with national emergencies.',
            order: 1,
        },
        {
            title: 'Process of Constitutional Amendments',
            content: "An overview of the procedure for amending Pakistan's Constitution.",
            order: 2,
        },
        {
            title: 'Impact on Governance',
            content: "This lesson explores how emergency powers and amendments have affected Pakistan's governance.",
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module2_5.id } }));
    ...
    const lessons3_1 = [
        {
            ...
            content: 'This lesson examines the essential components that constitute a criminal offense.',
            order: 1,
        },
        {
            title: 'Mens Rea and Actus Reus',
            content: 'An overview of the mental and physical elements required for criminal liability.',
            order: 2,
        },
        {
            title: 'Strict Liability Offenses',
            content: 'This lesson explores crimes that do not require proof of mental intent.',
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module3_1.id } }));
    ...
    const lessons3_2 = [
        {
            ...
            content: 'This lesson examines the legal definitions and elements of killing offenses.',
            order: 1,
        },
        {
            title: 'Assault and Battery',
            content: 'An overview of crimes involving physical attacks and threats of violence.',
            order: 2,
        },
        {
            title: 'Kidnapping and Abduction',
            content: 'This lesson explores offenses involving the forcible taking of persons.',
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module3_2.id } }));
    ...
    const lessons3_3 = [
        {
            ...
            content: 'This lesson examines crimes involving the taking of property with and without force.',
            order: 1,
        },
        {
            title: 'Criminal Breach of Trust',
            content: 'An overview of offenses where someone misappropriates property entrusted to them.',
            order: 2,
        },
        {
            title: 'Fraud and Cheating',
            content: 'This lesson explores crimes involving deception for financial gain.',
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module3_3.id } }));
    ...
    const lessons3_4 = [
        {
            ...
            content: 'This lesson examines the legal procedures for criminal investigations and apprehending suspects.',
            order: 1,
        },
        {
            title: 'Bail and Remand',
            content: 'An overview of provisions relating to temporary release and detention during trial.',
            order: 2,
        },
        {
            title: 'Trial Process',
            content: 'This lesson explores the stages and procedures of criminal trials in Pakistan.',
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module3_4.id } }));
    ...
    const lessons3_5 = [
        {
            ...
            content: 'This lesson examines what evidence can legally be presented in court.',
            order: 1,
        },
        {
            title: 'Examination of Witnesses',
            content: 'An overview of procedures for questioning witnesses in criminal trials.',
            order: 2,
        },
        {
            title: 'Judgment and Sentencing',
            content: 'This lesson explores how courts reach verdicts and determine punishments.',
            order: 3,
        },
    ].map((lesson) => lessonRepo.create({ ...lesson, module: { id: module3_5.id } }));
    ...
    for (const questionData of questionsForQuiz1_1_1) {
        ...
        const options = await optionRepo.save(questionData.options.map((text) => optionRepo.create({ text, question: { id: question.id } })));
    ...
    const testQuestions1 = [
        ...
        {
            question: 'Which article of the Constitution of Pakistan deals with the fundamental right to life?',
            order: 5,
    ...
    const testQuestions2 = [
        ...
        {
            question: 'Which amendment to the Constitution of Pakistan established the Federal Shariat Court?',
            order: 2,
            options: [
                'Eighth Amendment',
                'Twelfth Amendment',
        ...
        {
            question: "What is the significance of the Eighteenth Amendment to Pakistan's Constitution?",
            order: 3,
            options: [
        ...
        {
            question: "Which of the following is NOT a fundamental right under Pakistan's Constitution?",
            order: 4,
            options: [
                'Right to fair trial',
                'Freedom of speech',
    ...
    const testQuestions3 = [
        ...
        {
            question: 'What is the difference between murder and culpable homicide in Pakistani law?',
            order: 2,
            options: [
        ...
        {
            question: 'Which of the following is NOT an element of the crime of theft?',
            order: 3,
            options: [
                'Dishonest intention',
                'Taking possession',
        ...
        {
            question: 'Under Pakistani law, which type of evidence is generally NOT admissible in court?',
            order: 5,
            options: [
